...
import { signup, clearError } from '../redux/authSlice'; // Adjust path based on your file structure
    ...
    <div className="min-h-screen bg-linear-to-br from-blue-600 via-blue-700 to-indigo-800 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Jewel Tech Admin Panel</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 sr-only">First Name</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 sr-only">Last Name</label>
              <div className="relative">
                <User size={20} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2 sr-only">Mobile Number</label>
            <div className="relative">
